...
public class AuthController {
    ...
    public ResponseEntity<String> getPublicKey(@RequestParam String username,
        ...
        if (passwordEncoder.matches(password, userDetails.getPassword())) {
            System.out.println("VERIFIED");
            pubKey = CryptoUtil.getPublicKeyString(MWProperty.vehicleOEMIndex);
    ...
    public ResponseEntity<String> getEncryptedBid(@RequestParam String username,
        ...
        if (passwordEncoder.matches(password, userDetails.getPassword())) {
            System.out.println("VERIFIED");
            encryptedString = CryptoUtil.getEncryptedData(data, MWProperty.vehicleOEMIndex);
    ...
    public ResponseEntity<String> getDecryptedBid(@RequestParam String username,
        ...
        if (passwordEncoder.matches(password, userDetails.getPassword())) {
            System.out.println("VERIFIED");
            decryptedString = CryptoUtil.getDecryptedData(encryptedData, MWProperty.vehicleOEMIndex);
    ...
    public ResponseEntity<String> isDeployed(@RequestParam String username,
        ...
        if (passwordEncoder.matches(password, userDetails.getPassword())) {
            return ResponseEntity.ok("I am Deployed by Vehicle OEM");
        }
        throw new ResponseStatusException(HttpStatus.UNAUTHORIZED, "User not authenticated");
    }

    @PostMapping(path = "/deployementStatus")
    public ResponseEntity<String> deploymentStatus() {
