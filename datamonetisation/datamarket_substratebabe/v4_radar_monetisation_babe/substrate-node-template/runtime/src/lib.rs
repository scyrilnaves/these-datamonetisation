...
//default 6000
pub const MILLISECS_PER_BLOCK: u64 = 90000;
...
parameter_types! {
	...
	//pub const SpecialAccountId: AccountId = AccountId::from(
		...
		//pub const SpecialAccountId: AccountId= AccountId::from("60f28d2abe90a6bbfef78dc50bf798d52582b1da3868d8f470b22831e5edac73");
}
...
impl pallet_template::Config for Runtime {
	type Event = Event;
	type AssetRandomness = RandomnessCollectiveFlip;
	type AssetServiceRandomness = RandomnessCollectiveFlip;
	//type Balanced = Balance;
	//type SpecialAccountId = Self::SpecialAccountId;
