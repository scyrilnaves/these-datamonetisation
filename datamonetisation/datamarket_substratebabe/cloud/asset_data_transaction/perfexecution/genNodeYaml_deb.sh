...
docker run -it cyrilthese/datamonetisation_aura:latest node-template build-spec --disable-default-bootnode --chain local >customSpec.json
...
#build raw chainSpec
docker run -it -v $(pwd)/customSpec.json:/customSpec.json cyrilthese/datamonetisation_aura:latest node-template build-spec --chain=/customSpec.json --raw --disable-default-bootnode >customSpecRaw.json
